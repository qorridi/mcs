...
class Expansionpanel_small extends StatefulWidget {
  Expansionpanelstate_small createState() => Expansionpanelstate_small();
}

class Expansionpanelstate_small extends State<Expansionpanel_small> {
...
ListTile _posisi(String namaposisi) {
  return ListTile(
    ...
    title: Text(
      namaposisi,
      style: GoogleFonts.poppins(
          fontWeight: FontWeight.w500, fontSize: 14, letterSpacing: 1.2),
    ),
  );
}
